...
const TodoList = () => {
  ...
  const items = [
    {key: 'all', label: 'All', children: <TodoTab todos={todos} onTodoToggle={handleToggleTodoStatus} onTodoRemoval={handleRemoveTodo} />},
    {key: 'active', label: 'Active', children: <TodoTab todos={activeTodos} onTodoToggle={handleToggleTodoStatus} onTodoRemoval={handleRemoveTodo} />},
    {key: 'complete', label: 'Complete', children: <TodoTab todos={completedTodos} onTodoToggle={handleToggleTodoStatus} onTodoRemoval={handleRemoveTodo} />},
  ]
